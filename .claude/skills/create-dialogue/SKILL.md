...
- **The variation plan** — how the shape gets worked, and how many turns that yields. Moves: answer it · negate it · swap the filler · add a qualifier · hear it said back. Every move is an operation on the SHAPE — the wrongness that earns a repeat belongs to the character (see the engines below).
