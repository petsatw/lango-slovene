...
- [ARCHITECTURE.md](ARCHITECTURE.md) — what the system is today and the files that matter.
- [ROADMAP.md](ROADMAP.md) — where it's going, from first principles, and the pieces to get there.
